...
//الكيت داتا ترجعلنا اما خطا معين اما المصفوفة الي بيها البيانات
    var response=await logindata.postdata( email_controller.text,password_controller.text);
...
if(StatusRequest.success==statusRequest){
 ...
 myservices.sharedPreferences.setString("gender", response['data']['users_gender'].toString());
...
update();
  ...
  @override
  goToSignUp() {
   Get.offAllNamed(Approute.screenSingup);
  }
@override
  void onInit() {
    print("------------------------------------");
